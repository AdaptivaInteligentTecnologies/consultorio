<?php
/**
 * SystemPerfis Active Record
 * @author  <your-name-here>
 */
class SystemPerfis extends TRecord
{
...
//    private $system_programs = array();
    ...
    public function __construct($id = NULL)
    {
        ...
        parent::addAttribute('prf_nome');
        parent::addAttribute('prf_ativo');
        parent::addAttribute('prf_dt_criacao');
    }
     ...
     */
    public function addModulos(SystemModulos $object)
    {
        $this->modulos[] = $object;
    }
    ...
    public function load($id)
    {
        ...
        $repository = new TRepository('SystemModulos');
