...
$(window).load(function() {
    ...
    function resizeFBcomments(){
        $(".comments-fb").addClass('fb-comments').attr("data-width", $(".comments").width());
