...
class FilaAtendimentoForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $cns_queixa_principal = new THtmlEditor('cns_queixa_principal'); // queixa principal
        $cns_queixa_principal->setSize(700);
        
        $cns_historico_doenca_atual = new THtmlEditor('cns_historico_doenca_atual'); // hda
        $cns_historico_doenca_atual->setSize(700);
        
        
        $cns_evolucao = new THtmlEditor('cns_evolucao');
        $cns_evolucao->setSize(700);
        ...
        $scrollAnamnese->add($cns_queixa_principal);
        ...
        $scrollAnamnese->add($h2);
        $scrollAnamnese->add($cns_historico_doenca_atual);
        ...
        $tabPaneEvolucao->add($cns_evolucao);
        ...
        //$divCabecalho->add($toolBarConsultaPaciente);
