...
class EspecialidadeProfissionalForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        parent::__construct();
        // creates the form
        $this->form = new TForm('form_Especialidade_Profissional');
...
/*
        $multifield_programs->setClass('EspecialidadeProfissional');
...
//        $cell->colspan = 2;
        ...
        $list_button->setAction(new TAction(array('EspecialidadeProfissionalList','onReload')), _t('Back to the listing'));
        ...
        $container->addRow()->addCell(new TXMLBreadCrumb('menu.xml', 'EspecialidadeProfissionalList'));
    ...
    function onSave()
    {
        try
        {
            ...
            $object = $this->form->getData('EspecialidadeProfissional');
