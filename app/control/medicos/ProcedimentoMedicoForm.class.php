<?php
/**
 * ProcedimentoMedicoForm Registration
 * @author  <your name here>
 */
class ProcedimentoMedicoForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new TForm('form_ProcedimentoMedico');
        ...
        $row->addCell( new TLabel('ProcedimentoMedico') )->colspan = 2;
        ...
        $list_button = TButton::create('list', array('ProcedimentoMedicoList','onReload'),_t('Back to the listing'),'ico_datagrid.png');
    ...
    function onSave()
    {
        try
        {
            ...
            // get the form data into an active record ProcedimentoMedico
            $object = $this->form->getData('ProcedimentoMedico');
