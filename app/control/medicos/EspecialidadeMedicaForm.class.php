...
class EspecialidadeMedicaForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        parent::__construct();
        // creates the form
        $this->form = new TForm('form_Especialidade_medica');
...
//        $cell->colspan = 2;
        ...
        $list_button->setAction(new TAction(array('EspecialidadeMedicaList','onReload')), _t('Back to the listing'));
        ...
        $container->addRow()->addCell(new TXMLBreadCrumb('menu.xml', 'EspecialidadeMedicaList'));
    ...
    function onSave()
    {
        try
        {
            ...
            $object = $this->form->getData('EspecialidadeMedica');
