...
class TipoContatoForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        parent::__construct();
        // creates the form
        $this->form = new TForm('form_tipo_contato');
...
//        $cell->colspan = 2;
        ...
        $container->addRow()->addCell(new TXMLBreadCrumb('menu.xml', 'TipoContatoList'));
    ...
    function onSave()
    {
        try
        {
            ...
            $object = $this->form->getData('TipoContato');
            ...
            new TToast('Tipo de contato salvo com sucesso!');
            // reload the listing
        }
